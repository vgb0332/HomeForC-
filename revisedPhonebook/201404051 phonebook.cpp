...
string findName(int number , string email); //findName 선언 수정
...
int main ()
{
	...
	remove("Kang JH");          //내용 5
	remove("Kim KS");           //내용 5
	insert("Won GS", 5462);     //내용 6
	insert("Kwon KY", 5825);    //내용 6
	insert("Kim MG", 5957);     //내용 6
	insert("Jung YS", 5);       //내용 6
	insert("Lee SH", 5068);     //내용 6: 중복 테스트
	update("Jung YS", 5457);    //내용 7

	insert("Lee YH", 5000);     //내용 8
	remove("Lee YH");           //내용 8
	update("Lee YH", 5068);     //내용 8
